        ...
        <div class="pub-search">
          <el-form value={this.form}>
            {this.fullSearch && !this.isShowAdvancedSearch.value ? (
                    ...
                    <el-input
                      ...
                      {...{
                        'onUpdate:modelValue': (e: string | number) => {
                          this.$set(this.form, 'fullText', typeof e === 'string' ? e.trim() : e);
                        }
                      }}
                      onClear={() => {
                        this.onSubmit();
              ...
              <el-row gutter={this.gutter} type={this.type} justify={this.justify}>
                {this.renderItems.value.map((item: IRenderItem) => {
                ...
                <div class="pub-search-btn-group">
                  ...
                  {this.isSeperator ? (
                    this.isShowMore ? (
                      <el-button class="pub-search-btn" type="text" on-click={() => (this.isShowMore = false)}>
                        {this.$t('button.packUp')}
                        <i class="el-icon-arrow-up el-icon--right"></i>
                      </el-button>
                    ) : (
                      <el-button class="pub-search-btn" type="text" on-click={() => (this.isShowMore = true)}>
